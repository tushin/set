...
import com.sully.set.ui.theme.GameButtonColor
import com.sully.set.ui.theme.GameButtonText
        ...
        BoxWithConstraints(
                modifier =
                        Modifier.fillMaxSize()
                                .background(com.sully.set.ui.theme.DarkGreenBackground)
        ) {
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
                ...
                for (i in 0 until cols) {
                        for (j in 0 until rows) {
                                ...
                                val y = j * stepY
                                drawCircle(
                                        color = Color(0xFF00332B).copy(alpha = 0.2f),
                                        radius = 50f,
