...
package `set`.composeapp.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/set.composeapp.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/set.composeapp.generated.resources/" + path)
